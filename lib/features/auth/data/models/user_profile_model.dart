...
class UserProfileModel {
  ...
  static UserProfileEntity fromMap(Map<String, dynamic> map) {
    return UserProfileEntity(
      ...
      birthday: (map['birth_date'] as String?) ?? (map['birthday'] as String?) ?? '',
      instagram: map['instagram'] as String? ?? '',
      educationDegree: (map['level_of_education'] as String?) ?? (map['education_degree'] as String?) ?? '',
      jobPosition: (map['job'] as String?) ?? (map['job_position'] as String?) ?? '',
